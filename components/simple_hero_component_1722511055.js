...
*/
Vue.component("simple_hero_component_1722511055", {
    template: `
        <section id="hero-section" class="bg-gradient-to-br from-purple-900 via-pink-700 to-indigo-800 flex-1">
            <div id="hero-container" class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
                <div id="hero-text-container" class="mr-auto place-self-center lg:col-span-7 bg-white bg-opacity-20 backdrop-filter backdrop-blur-lg rounded-xl p-8 shadow-lg">
                    ...
                    <div id="hero-subtitle-container" class="flex">
                        <p id="hero-subtitle" class="flex-1 max-w-2xl mb-6 font-light text-pink-200 lg:mb-8 md:text-lg lg:text-xl">Harness the Power of Blockchain Analytics</p>
                    </div>

                    <div id="hero-buttons-container" class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                        <div id="hero-button-1-container" class="flex">
                            <a id="hero-button-1" href="https://github.com/themesberg/landwind" class="flex-1 items-center justify-center w-full px-5 py-3 text-sm font-medium text-center text-purple-900 bg-white bg-opacity-30 border border-pink-300 rounded-lg sm:w-auto hover:bg-opacity-50 focus:ring-4 focus:ring-pink-300 transition duration-300">Get Started</a>
                        </div>

                        <div id="hero-button-2-container" class="flex">
                            <a id="hero-button-2" href="https://www.figma.com/community/file/1125744163617429490" class="flex-1 items-center justify-center w-full px-5 py-3 mb-2 mr-2 text-sm font-medium text-white bg-purple-700 bg-opacity-30 border border-purple-500 rounded-lg sm:w-auto hover:bg-opacity-50 focus:outline-none focus:ring-4 focus:ring-purple-500 transition duration-300">Learn More</a>
                        </div>
                    </div>
